#ref https://github.com/techmatters/terraso-backend/blob/main/terraso_backend/apps/auth/views.py
...
class AbstractCallbackView(View):
    # 3rd party sends GET request to localhost:8000/auth/provider/callback
    def get(self, request, *args, **kwargs):
